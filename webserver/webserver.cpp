...
void WebServer::sql_pool()
{
    ...
    m_connPool->init("localhost", m_user, m_password, m_databaseName, 3306, m_sql_num, _close_log);
...
void WebServer::event_listen()
{
    ...
    clz_conn::pipefd = m_pipefd;
    clz_conn::epollfd = m_epollfd;
}

void WebServer::timer(int connfd, struct sockaddr_in client_address)
{
    users[connfd].init(connfd, client_address, m_root, m_CONNTrigmode, _close_log, m_user, m_password, m_databaseName);
